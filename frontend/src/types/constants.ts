...
import type { JournalLineForm, JournalEntryForm } from "../types/journal";

// Konfigurasi tampilan status jurnal di UI
...
// Helper: buat satu baris jurnal kosong untuk form input
...
// Nilai default form jurnal baru
...
// Minimal jumlah line dalam jurnal
export const MIN_LINES = 2;

// Daftar tipe akun yang dipakai di form/filter
...
// Mapping type akun -> normal balance default
...
// Kelas CSS per tipe akun untuk badge, pill, dan tombol UI
...
// Validasi format kode akun, misalnya 100, 1100, 123456
